...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('accounts', '0018_auto_20150621_1605'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('post', models.ForeignKey(related_name='interest_post', to='posts.Posts')),
                ('tracker', models.ForeignKey(related_name='interest_track', to='accounts.IpTracker')),
            ],
        ),
        migrations.AddField(
